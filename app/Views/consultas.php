<main style="background-image: url('assets/img/contacto.jpg');
    ...
    <div class="container"   >
        <h1 style="text-align: center; margin-bottom: 30px; padding-top: 20px">Consulta</h1>
        ...
        <?php endif; ?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nombre" name="nombre" required value="<?php echo $usuario['nombre']; ?>">
            </div>
            <div class="form-group">
