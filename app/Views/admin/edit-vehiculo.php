...
<!--  <div style="width: 50%; margin: auto; overflow: hidden;"> -->
        <h2 style="text-align: center; padding: 20px;">Modificar Vehiculo</h2>
        ...
        action="<?php echo base_url('api/vehiculos/new'); ?>"
         method="post" enctype="multipart/form-data" style="padding: 10px; gap: 5px; display: flex; flex-wrap: wrap;">
                    ...
                    <?php foreach ($marcas as $marca): ?>
                        <option
                            <?php if($vehiculo['marca'] == $marca) echo 'selected'; ?>
                ...
                value="<?php echo  $vehiculo['precio']; ?>"
                >
                ...
                value="<?php echo  $vehiculo['motor']; ?>"
                > 
                <div style="align-items: center; display: flex; flex-direction: column; flex: 0 0 calc(50% - 5px); width: 100%;">       
                <input type="file" id="img" name="img" style="padding: 10px; margin-bottom: 10px; border-radius: 4px;"                
                >
                <img width="150px" src="<?php echo base_url('assets/img/uploads/' . $vehiculo['img']); ?>" >
                </div>
                <textarea placeholder="Descripción" id="descripcion" name="descripcion" rows="4" required style="flex: 0 0 calc(50% - 5px); width: 100%; padding: 10px; margin-bottom: 10px; border: 1px solid #ccc; border-radius: 4px;"
                >
